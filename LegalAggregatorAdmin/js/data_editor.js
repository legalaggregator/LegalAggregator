...
window.data_editor.truncate_table = function () {
    if (confirm("Are you sure you wish to truncate this table (delete all rows)? This operation is permanent.")) {
        $("#data_editor_cmd").val("truncate");
